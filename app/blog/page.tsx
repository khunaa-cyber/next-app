...
export default function BlogPage() {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        'Хүүхдийн шүдний эрүүл мэндийг хэрхэн хамгаалах, зөв дадал зуршил төлөвшүүлэх талаар мэдээлэл.',
      date: '2023-06-22',
      author: 'С. Мөнхзул',
    ...
    },
    {
      ...
      excerpt:
        'Насанд хүрэгчдэд зориулсан шүдний гажиг засал, үүний давуу талууд болон сонголтууд.',
      date: '2023-09-18',
      author: 'Г. Оюунчимэг',
    ...
    },
    {
      ...
      excerpt:
        'Шүдний цайралтын талаар мэдэх ёстой бүх зүйл: үр дүн, аюулгүй байдал, арчилгаа.',
      date: '2023-10-30',
      author: 'Н. Энхбаяр',
