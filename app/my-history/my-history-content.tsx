        ...
        try {
          ...
          if (profileResponse.success) {
            setProfile({
              ...
              address:
                profileResponse.user.address ||
                'Баянзүрх дүүрэг, 13-р хороолол',
                    ...
                    <tbody>
                      {appointments.map((appointment) => (
                        <tr key={appointment.id}>
                          ...
                          <td>
                            <span
                              className={`status ${appointment.status === 'Дууссан' ? 'completed' : 'upcoming'}`}
                            >
                              {appointment.status}
                            </span>
                          </td>
                          ...
                          <td>
                            {appointment.status !== 'Дууссан' && (
                              <button className='button small'>Цуцлах</button>
                            )}
                          </td>
                        </tr>
                      ))}
                        ...
                        <div className='treatment-card' key={appointment.id}>
                          <div className='treatment-date'>
                            ...
                            <div className='treatment-info'>
                              <div className='treatment-date-text'>
                                {appointment.date}
                              </div>
                              <div className='treatment-doctor'>
                                Эмчлэгч эмч: {appointment.doctor}
                              </div>
                              <div className='treatment-type'>
                                Үйлч: {appointment.service}
                              </div>
                            </div>
                          </div>
