    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (servicesResponse.success) {
          setServices(
            servicesResponse.services.map(
              (service: { id: { toString: () => any }; title: any }) => ({
        ...
        if (doctorsResponse.success) {
          setDoctors(
            doctorsResponse.doctors.map(
              (doctor: { id: any; name: any; position: any }) => ({
                id: doctor.id,
                name: doctor.name,
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(
          response.message || 'Цаг захиалахад алдаа гарлаа. Дахин оролдоно уу.'
        );
      }
    } catch (error) {
