    ...
    return (
      <section className='feedback-section'>
        <div className='feedback-success'>
          ...
          <h2>Баярлалаа!</h2>
          <p>
            Таны санал хүсэлтийг хүлээн авлаа. Бид таны саналыг анхааралтай
            судалж, үйлчилгээгээ сайжруулахад ашиглах болно.
          </p>
    ...
    <section className='feedback-section'>
      <div className='feedback-container'>
        <div className='feedback-info'>
          ...
          <p>
            Бид үйлчилгээгээ тасралтгүй сайжруулахыг зорьж байна. Таны санал
            хүсэлт, шүүмжлэл бидэнд маш их тусална. Та доорх маягтыг бөглөн
            илгээнэ үү.
          </p>
