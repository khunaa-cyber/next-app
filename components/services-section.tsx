...
export function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      title: 'Аюулгүй орчин',
      description:
        'Дижитал ариутгалын системээр халдваргүйжүүлэлт хийж, эрүүл ахуйн стандартыг чанд сахина.',
    },
    {
      image: '/review2.png',
      title: 'Нарийн оношилгоо',
      description:
        'Шинэлэг технологийн тусламжтайгаар хурдан, нарийн оношилгоо үзүүлнэ.',
    },
    {
      image: '/review4.png',
    ...
    },
    {
      ...
      description:
        'Тохилог тав тухтай хүлээх танхим, хүүхдийн буланг багтаасан.',
    },
    {
      image: '/review1.png',
